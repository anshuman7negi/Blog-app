...
RSpec.describe 'User Show Page', type: :system do
  before do
    ...
    @post2 = Post.create(author: @first_user, title: 'Post2', text: 'This is the second post.', comments_counter: 0, likes_counter: 0)
    @post3 = Post.create(author: @first_user, title: 'Post3', text: 'This is the third post.', comments_counter: 0, likes_counter: 0)
    @post4 = Post.create(author: @first_user, title: 'Post4', text: 'This is the fourth post.', comments_counter: 0, likes_counter: 0)
